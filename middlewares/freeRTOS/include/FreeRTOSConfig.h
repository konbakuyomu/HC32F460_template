...
**********************************************************************/
#define configRECORD_STACK_HIGH_ADDRESS                 1                   /* 1: 记录堆栈高地址, 0: 不记录 */
#define configGENERATE_RUN_TIME_STATS                   1                   /* 1: 生成运行时统计信息, 0: 不生成 */
#define configUSE_TRACE_FACILITY                        1                   /* 1: 启用跟踪功能, 0: 不启用 */
#define portCONFIGURE_TIMER_FOR_RUN_TIME_STATS()        (CPU_RunTime = 0ul) /* 初始化运行时间计数器 */
#define portGET_RUN_TIME_COUNTER_VALUE()                (CPU_RunTime)       /* 获取运行时间计数器 */
